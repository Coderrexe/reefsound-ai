...
import os
os.path.join('/Users/simbashi/Library/CloudStorage/OneDrive-Personal/Conrad Challenge/ReefSound AI/model1/Audioset')
import vggish_input
...
checkpoint_path = r'/root/yimei/model2/Reef-acoustics-and-AI-v1.2/Audioset/vggish_model.ckpt'
pca_params_path = r'/root/yimei/model2/Reef-acoustics-and-AI-v1.2/Audioset/vggish_pca_params.npz'
